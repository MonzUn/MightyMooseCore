...
namespace Eco.Moose.Utils.Lookups
{
    public static class Lookups
    {
        ...
        public static User OnlineUserBySteamOrSlgId(string steamId, string slgId) => OnlineUsers.FirstOrDefault(user => user.SteamId.Equals(steamId) || user.SlgId.Equals(slgId));
